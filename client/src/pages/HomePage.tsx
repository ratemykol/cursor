...
export const HomePage = (): JSX.Element => {
  ...
  return (
    <div className="bg-white w-full min-h-screen">
      <div className="bg-white overflow-hidden w-full max-w-[1920px] relative min-h-screen mx-auto">
        ...
        <section className="mt-[120px] relative">
          ...
          <div className="absolute w-[150px] h-[223px] top-[704px] left-[1307px] bg-[#e2dffd] rounded-[75.5px/111.3px] rotate-[-18deg] mt-[-888px] mb-[-888px] ml-[-172px] mr-[-172px]" />
