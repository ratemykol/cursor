          ...
          <div className="mt-16 relative max-w-3xl mx-auto z-[10]" ref={dropdownRef}>
            <div className="relative">
              <div className="relative">
                ...
                />
                <Button 
                  className="absolute right-[2px] top-[2px] h-[calc(100%-4px)] w-[108px] bg-[#ab9ff2] text-[#3c315b] rounded-r-[10px] rounded-l-none font-medium transition-all duration-300 ease-in-out hover:scale-105 hover:bg-[#DCDAF0] hover:shadow-lg transform-gpu flex items-center justify-center border-0"
                  onClick={() => {
                    if (searchQuery.trim()) {
